...
class Homework:
    ...
    def __init__(self, text: str, deadline: int, created_by: str = None):
        self.text = text
        self.deadline = datetime.timedelta(deadline).days
    ...
    def is_active(self) -> bool:
        ...
        """
        return (datetime.datetime.now() - self.created).days < self.deadline
...
class Teacher(Person):
    ...
    @staticmethod
    def create_homework(text: str, deadline: int, created_by: str = None) -> Homework:
        ...
        return Homework(text, deadline, created_by)
    ...
    def get_done_homework(self):
        dct = {}
        dct |= self.homework_done
        return dct
